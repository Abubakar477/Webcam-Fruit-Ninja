...
3. **Add the upstream remote** so you can pull future updates from the source.
   ```powershell
   git remote add upstream https://github.com/<original-repo>/ninja-fruit.git
   ```
...
To contribute back, push a branch to your fork and open a pull request targeting `<original-repo>/ninja-fruit`.
